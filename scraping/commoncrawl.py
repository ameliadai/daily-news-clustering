...
my_local_download_dir_warc = '/vast/hd2584/news-please/cc_download_warc_2025_01_03_new/'
# download dir for articles
my_local_download_dir_article = '/vast/hd2584/news-please/cc_download_articles_2025_01_03_new/'
...
my_filter_valid_hosts =[
    ...
    "theenterprisleader.com",
    "www.wkrb13.com",
    "www.themarketsdaily.com",
    "www.yahoo.com",
    "menafn.com",
    "www.dailymail.co.uk"
] # ['www.cbsnews.com', 'www.forbes.com', 'www.cnn.com', 'www.npr.org', 'www.cnbc.com']  # example: ['elrancaguino.cl']
# start date (if None, any date is OK as start date), as datetime
my_filter_start_date = datetime.datetime(2025, 1, 1)  # datetime.datetime(2016, 1, 1)
# end date (if None, any date is OK as end date), as datetime
my_filter_end_date = datetime.datetime(2025, 4, 1)  # datetime.datetime(2016, 12, 31)
...
my_warc_files_start_date = datetime.datetime(2025, 1, 1) # example: datetime.datetime(2020, 3, 1)
my_warc_files_end_date = datetime.datetime(2025, 4, 1) # example: datetime.datetime(2020, 3, 2)
