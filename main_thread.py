...
def main(args):
    ...
    chunk_size = (date_N + N -1)//N
    date_strs = [date_strs[i: i+chunk_size]
                for i in range(0, date_N, chunk_size)]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--N', type=int, default=4, help='Number of threads to use')
